...
class Snormal extends StatefulWidget {
  Snormal({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _SnormalState createState() => _SnormalState();
}

class _SnormalState extends State<Snormal> {
  ...
  _shuffle() {
    ...
    _s = 0;
    _a = Random().nextInt(156) + 100;
    /*if(_rgb==1){
        Color.fromARGB( 255, _RGB[i], _f, _s);
        print("1 G:$_f B:$_s");
      }else if(_rgb==2){
        Color.fromARGB( 255, _f,_RGB[i], _s);
        print("2 R:$_f B:$_s");
      }else if(_rgb==3){
        Color.fromARGB( 255, _f, _s, _RGB[i]);
        print("3 R:$_f G:$_s");
      }*/
    ...
    setState(() {
      //_RGB.shuffle();
      Color.fromARGB(_a, _RGB[_i], _f, _s);
      //MyColor
    });
  }
  ...
  Color Myrgb() {
    ...
    if (_rgb == 1) {
      print("1 G:$_f B:$_s");
      return Color.fromARGB(_a, 255, _f, _s);
    } else if (_rgb == 2) {
      print("2 R:$_f B:$_s");
      return Color.fromARGB(_a, _f, 255, _s);
    } else if (_rgb == 3) {
      print("3 R:$_f G:$_s");
      return Color.fromARGB(_a, _f, _s, 255);
    }
  }
                              ...
                              child: SizedBox(
                                ...
                                child: Stack(
                                  ...
                                  children: List.generate(_RGB.length, (i) {
                                    return Box2(
                                      color: _rgb == 1
                                          ? Color.fromARGB(_a, _RGB[i], _f, _s)
                                          : _rgb == 2
                                              ? Color.fromARGB(
                                                  _a, _f, _RGB[i], _s)
                                              : Color.fromARGB(
