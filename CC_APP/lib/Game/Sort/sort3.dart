...
class Shard extends StatefulWidget {
  Shard({Key key, this.title}) : super(key: key);

  final String title;
  @override
  _ShardState createState() => _ShardState();
}
...
class _ShardState extends State<Shard> {
  ...
  Color Myrgb() {
    ...
    if (_rgb == 1) {
      print("1 G:$_f B:$_s");
      return Color.fromARGB(255, 255, _f, _s);//r(b)
    }
    else if (_rgb == 2) {
      print("2 R:$_f B:$_s");
      return Color.fromARGB(255, 255, _s, _f);//r(g)
    }
    else if (_rgb == 3) {
      print("3 R:$_f G:$_s");
      return Color.fromARGB(255, _f, 255, _s);//g(b)
    }else if (_rgb == 4) {
      print("2 R:$_f B:$_s");
      return Color.fromARGB(255, _s, 255, _f);//g(r)
    }
    else if (_rgb == 5) {
      print("3 R:$_f G:$_s");
      return Color.fromARGB(255, _f, _s, 255);//b(g)
    }else if (_rgb == 6) {
      print("2 R:$_f B:$_s");
      return Color.fromARGB(255, _s, _f, 255);//b(r)
    }
  }
          ...
          _win !=1?Center(
            child: Column(
              children: [
                ...
                /*Container(
                  color: Color.fromARGB(255, 254, 228, 172),
                  child: _rgb ==1 ?Text("Sort R B=$_s",style: TextStyle(fontSize: 20))
                      :_rgb ==2 ?Text("Sort R G=$_s",style: TextStyle(fontSize: 20))
                      :_rgb ==3 ?Text("Sort G B=$_s",style: TextStyle(fontSize: 20))
                      :_rgb ==4 ?Text("Sort G R=$_s",style: TextStyle(fontSize: 20))
                      :_rgb ==5 ?Text("Sort B G=$_s",style: TextStyle(fontSize: 20))
                      :Text("Sort B R=$_s",style: TextStyle(fontSize: 20)),

                ),*/
                //Text("1 G:$_f B:$_s _RGB[_i]:${_RGB[_i]} _I:$_i", style: TextStyle(fontSize: 20)),
                Text('$_time',
                  style: TextStyle(
                    fontFamily: 'Mononoki',
                    fontSize: 30.0,
                    ...
                    child: SizedBox(
                      ...
                      child :Stack(
                        ...
                        children: List.generate(_RGB.length,(i){
                          return Box2(
                            color :_rgb == 1? Color.fromARGB(255, _RGB[i], _f, _s)
                                :_rgb == 2 ? Color.fromARGB(255, _RGB[i], _s, _f)
                                :_rgb == 3 ? Color.fromARGB(255, _f, _RGB[i], _s)
                                :_rgb == 4 ?Color.fromARGB(255, _s, _RGB[i], _f)
                                :_rgb == 5 ? Color.fromARGB(255, _f, _s, _RGB[i])
                                : Color.fromARGB(255, _s, _f, _RGB[i]),
