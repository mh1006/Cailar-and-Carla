  ...
  Widget build(BuildContext context){
    ...
    return Column(
      children: <Widget>[
        ...
        _bulidSlider(
          label: "S=${(UniqueColorGenerator.targetcolor[1]*100).toInt()}%",
          color: HSLColor.fromAHSL(1, 0, 0, UniqueColorGenerator.targetcolor[1]).toColor(),
          value: UniqueColorGenerator.targetcolor[1],
          onChanged: (value) => UniqueColorGenerator.targetcolor[1],
        ),
        _bulidSlider(
          label:"L=${(UniqueColorGenerator.targetcolor[2]*100).toInt()}%",
          color: HSLColor.fromAHSL(1, 0, 0, UniqueColorGenerator.targetcolor[2]).toColor(),
          value: UniqueColorGenerator.targetcolor[2],
          onChanged: (value) => UniqueColorGenerator.targetcolor[2],
        ),
      ],
    );
  }
